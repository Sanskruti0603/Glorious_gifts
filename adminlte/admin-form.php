                 ...
                 <form method="post" id="myform">
                   <div class="card-body">
                     ...
                     <div class="form-group">
                       ...
                       <input type="password" name="txt3" class="form-control" id="exampleInputPassword3" placeholder="Enter Password" required>
                     </div>
                     <div class="form-group">
                       <label for="exampleInputPassword1">Mobile number</label>
                       <input type="text" name="txt4" class="form-control" id="exampleInputPassword2" placeholder="Enter Mobile number" required>
                     </div>
