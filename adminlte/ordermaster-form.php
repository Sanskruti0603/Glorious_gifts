              ...
              <form  method="post" >
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="date" name="txt1" class="form-control" id="exampleInputEmail1" placeholder="Enter date" require>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Ordermaster Status</label>
                    <input type="text" name="txt2" class="form-control" id="exampleInputPassword1" placeholder="Enter status"require>
                  </div>
                  <div class="form-group">
