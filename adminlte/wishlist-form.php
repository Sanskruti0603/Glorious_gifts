 <?php
  ...
  if($_POST)
  {
    ...
    $q=mysqli_query($connection,"insert into tbl_wishlist(user_id,product_id)
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo "</select>";
                    ?>
                    <!-- <input type="text" name="txt1" class="form-control" id="exampleInputEmail1" placeholder="Enter User-id" require> -->
                  </div>
