                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                   <?php
                    ...
                    // {
                    //     $deleteid=$_GET['did'];
                    //     $dq=mysqli_query($connection,"delete from tbl_admin where admin_id='{$deleteid}'");
                    ...
                    // echo "<td><a href='edit-admin.php?eid={$data['admin_id']}'>Edit</a> |
                    //   <a href='table.php?did={$data['admin_id']}' onclick='return checkdelete();'>Delete</a></td>";
                    //   echo "</tr>";
                    }
