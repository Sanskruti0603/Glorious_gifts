                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                   <?php
                    ...
                    {
                        $deleteid=$_GET['did'];
                        $dq=mysqli_query($connection,"delete from tbl_product where product_id='{$deleteid}'");
                    ...
                    while($data=mysqli_fetch_array($sq))
                    {
                      ...
                      echo "<td><a  target='_blank' href='uploads/{$data['product_photo']}'><img width='25' src='uploads/{$data['product_photo']}'></a></td>";
                    echo "<td><a href='edit-product.php?eid={$data['product_id']}'>Edit</a> |
                      <a href='product-table.php?did={$data['product_id']}' onclick='return checkdelete();'>Delete</a></td>";
                      echo "</tr>";
                    }
