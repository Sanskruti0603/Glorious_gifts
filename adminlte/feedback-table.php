                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                   <?php
                    ...
                    // {
                    //     $deleteid=$_GET['did'];
                    //     $dq=mysqli_query($connection,"delete from tbl_feedback where feedback_id='{$deleteid}'");
                    ...
                    //      }
                    // }
                    $sq=mysqli_query($connection,"select * from tbl_feedback");
                    ...
                    // echo "<td><a href='edit-feedback.php?eid={$data['feedback_id']}'>Edit</a> |
                    //   <a href='feedback-table.php?did={$data['feedback_id']}' onclick='return checkdelete();'>Delete</a></td>";
                    //   echo "</tr>";
                    }
