...
if($_POST)
{
  ...
  $date = date('Y-m-d');
  $uid = $_SESSION['uid'];
  $q = mysqli_query($connection,"insert into tbl_feedback (feedback_date,user_id,feedback_details,product_id) values('{$date}','{$uid}','{$txt1}','{$pid}')");
  if($q)
  {
    echo "<script>alert('Thank your for Feedback');window.location='view-order.php';</script>";
...
<section class="w3l-forml-main py-5" style="background-image: url('back.jpeg');background-repeat:no-repeat;background-size:cover;height:650px;">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 pb-3">
                        <div class="form-sub-w3">
                            <input type="text" name="txt1" placeholder="Enter Details" required="" />
                            <div class="icon-w3">
                        ...
                        <div class="submit-button text-center">
                                <button class="btn btn-style btn-primary" style="width:100%;">Submit</button>
                        </div>
