                    ...
                    <div class="ecom-contenthny-w3lcheckout privacy">
                        ...
                        <div class="checkout-right">
                            ...
                            if (isset($_POST["cart_update"])) {
                                ...
                                $cart_qty = mysqli_real_escape_string($connection, $_POST["cart_qty"]);


                                $single = $pdata['product_price'];
                                $final = $single * $cart_qty;
                                $query = mysqli_query($connection, "UPDATE tbl_cart SET quantity='{$cart_qty}' WHERE cart_id='{$cart_id}'");
                                $query45 = mysqli_query($connection, "UPDATE tbl_cart  SET price='{$final}' WHERE cart_id='{$cart_id}'");
                                if ($query && $query45) {
                                    echo "<script></script>";
                                }
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="rem1">
                                                ...
                                                <td class="invert-image"><a href="details.php">
                                                <a href='details.php?pid=<?php echo $pdata['product_id'];?>'><img src="<?php echo "uploads/{$pdata['product_photo']}"; ?>" class="img-fluid radius-image" alt="">
                                                    </a></td></a>
                                                <td class="invert">
                                                    ...
                                                    <form method="post">
                                                        <div class="pro-qty">
                                                            <div class="count-input-block">
                                                                ...
                                                                $pq = mysqli_query($connection, "select * from tbl_product where product_id='{$data['product_id']}'");
                                                                $pdata = mysqli_fetch_array($pq);
                                                                $qty = $pdata['product_quantity'];
                                                                if($qty>=1){
                                                                ?>
                                                                <input type="hidden" name="cart_id" value="<?php echo $data["cart_id"]; ?>">
                                                                <input type="number" min="1" max="<?php echo $pdata['product_quantity']; ?>" name="cart_qty" class="form-control text-center" value="<?php echo $cart_qty; ?>"><br>
                                                                <button type="submit" value="Update" name="cart_update" class="btn btn-success1">ADD</button>
                                                                <?php
                                                                }
                                                                else{
                                                                    ?>
                                                                   
                                                                    <button type="submit" value="Update" name="cart_update" class="btn btn-success1" disabled>ADD</button>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </div>
                                                ...
                                                <td class="invert">
                                                    <div class="rem">
                                                        <div class="close1">
                                                            ...
                                                            <a href='cart.php?did=<?php echo $data['cart_id']; ?>'>x</a>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row checkout-left mt-5">
                            <div class="col-md-4 checkout-left-basket">
                               <a href="shop.php"> <h4>Continue to basket</h4></a>
                                <ul>


                                    <li><b>Total</b> <i>-</i> <span><b><?php echo $grandtotal; ?></b></span></li>
                                </ul>
                            </div>

                        </div>

                        <input type="button" onclick="window.location='checkout.php?sub='+encodeURIComponent(<?php echo $grandtotal ?>);" value="Place Order" class="btn btn-success" />
