                            ...
                            ?>
                                <tr class="rem1">
                                    ...
                                    <td class="invert-image"><a href="product-single.html">
                                            <img src="<?php echo "uploads/{$pdata['product_photo']}"; ?>" class="img-fluid radius-image" alt="">
                                        </a></td>
                                    ...
                                    <td class="invert">
                                        <div class="rem">
                                            ...
                                            <a href='cart.php?did=<?php echo $data['cart_id'];?>'>  <i class="far fa-window-close"></i></a></div>
                                        </div>
