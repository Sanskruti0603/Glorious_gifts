                ...
                <div class="container">
                    <table border='1' class="table">
                        ...
                        <tbody>
                            ...
                            $sq = mysqli_query($connection, "select * from tbl_orderdetail where order_id ='{$oid}' ");
                            $gt = 0;
                            while ($data = mysqli_fetch_array($sq)) {
                                ...
                                $subtotal = $pdata['product_price'] * $data['orderdetail_quantity'];
                                $gt += $subtotal; 
                                echo "<tr>"; 
                                //echo "<td>{$data['orderdetail_id']}</td>";
                                echo "<td>{$data['order_id']}</td>";
                                echo "<td>{$pdata['product_name']}</td>";
                                echo "<td><img src='uploads/{$pdata['product_photo']}' width='100'/></td>";
                                echo "<td>{$pdata['product_price']}</td>";
                                echo "<td>{$data['orderdetail_quantity']}</td>";

                                echo "<td>$subtotal</td>";
                                echo "<td><a href='give-feedback.php?pid={$data['product_id']}'>Give Feedback</a></td>";
                                echo "<td><a href='order-status.php?oid={$data['order_id']}'>View Status</a></td>";

                                echo "</tr>";


                                // echo "<td><a href='edit-orderdetail.php?eid={$data['orderdetail_id']}'>Edit</a> |
                                //   <a href='orderdetail-table.php?did={$data['orderdetail_id']}' onclick='return checkdelete();'>Delete</a></td>";
                                //   echo "</tr>";
                            }

                            echo "<tr><td></td><td></td><td></td><td></td><td>Total</td><td>{$gt}</td></tr>";
                            ?>
