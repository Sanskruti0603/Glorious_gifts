                ...
                <div class="container">
                    <table border='1' class="table">
                        ...
                        <tbody>
                            ...
                            $sq = mysqli_query($connection, "select * from tbl_ordermaster where user_id ='{$uid}'");
                            ...
                            while ($data = mysqli_fetch_array($sq)) {
                                ...
                                echo "<td><a href='view-order-details.php?oid={$data['order_id']}'>Details</a>  | <a href='invoice.php?oid={$data['order_id']}'>Invoice</a> </td>";
                                echo "</tr>";
                            }
